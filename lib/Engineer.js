        ...
        <div class="card m-3">
          ...
          <div class="card-body body-bg">
            <ul class="list-group list-group-flush text">
              ...
              <li class="list-group-item"><b>Email:</b> <a href="mailto:${this.email}">${this.email}</a></li>
              <li class="list-group-item"><b>GitHub:</b> <a href="https://github.com/${this.github}" target="_blank">${this.github}</a></li>
            </ul>
          </div>
        </div>
      </div>
